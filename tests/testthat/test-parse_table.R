...
test_that("parse_table() works for HTML with a nested table with typo-ed '&nbsp;'", {
  d <- parse_test_table("nested-table-typoed-nbsp.html")[[1]]
...
test_that("parse_table() works for HTML with table without rows and typo-ed '&nbsp;' leftmost", {
  l <- parse_test_table("table-without-rows-and-typoed-nbsp-leftmost.html")
